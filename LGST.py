    ...
    digraph {
        ...
        A_SEC_PRIVATE [label=<
            <TABLE BORDER="0" CELLBORDER="1" CELLSPACING="0" CELLPADDING="6" STYLE="rounded" BGCOLOR="pink">
                <TR>
                    <TD FIXEDSIZE="TRUE" WIDTH="40" HEIGHT="40"><IMG SRC="https://raw.github.com/jaysonvertudazo49-web/LGST/blob/main/510653166_1032923245717783_1777335468481259373_n.jpg"/></TD>
